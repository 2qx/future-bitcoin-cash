...
import { TokenSendRequest, NFTCapability, OpReturnData, TestNetWallet, Connection } from "mainnet-js";
...
describe('test example contract functions', () => {
    it('should cat balance', async () => {
        const alice = await TestNetWallet.fromId(process.env["cFBCH_ID"]!);
        let conn = new Connection(
            "testnet",
            "wss://chipnet.bch.ninja:50004" 
            )
        //@ts-ignore
        alice.provider = conn.networkProvider
    ...
    it('should allow execution of a battery contract', async () => {
        ...
        var randomString = "Pi2WgMwKO6S1nqyu56M" // Array.from({ length: stringLength }, pickRandom).join('');
        ...
        //         "6a1846424348" + binToHex(utf8ToBin("-" + randomString)) +
        ...
        let batonCategory = "fbce0009ccce339e3398688d20fc60fce1c9316182c6680fe65e074e2fa046d2" 
        //swapEndianness(hash)
