...
export function getFbchIconSvgUri(n: number, size=400):string{
    ...
    `%3Cpath d='M 1 1 L 1 15 15 15 15 1 Z' style='stroke-width: 4px; stroke-linejoin: miter; stroke-linecap: butt; stroke: %23fff; fill: none;'%3E%3C/path%3E`+
    `%3Cpath d='M 1 1 L 1 15 15 15 15 1 Z' style='fill:%23` + xmlCodes[places[0]] + `;'%3E%3C/path%3E`+
