...
import { deriveHdPrivateNodeFromSeed, deriveHdPath, secp256k1, encodeCashAddress, deriveSeedFromBip39Mnemonic } from '@bitauth/libauth';
...
if (typeof aliceAddressResult !== 'string')
    throw new Error();
