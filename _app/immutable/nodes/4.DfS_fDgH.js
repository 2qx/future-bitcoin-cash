import{d as Vn}from"../chunks/index.R8ovVqwX.js";import{s as Mn,n as ln}from"../chunks/scheduler.Ce_0Mfso.js";import{S as Gn,i as Dn,e as p,s as e,H as on,c as o,k as u,f as c,l as Xn,d as s,a as cn,m as un,n as k,g as t}from"../chunks/index.B2XZWyz8.js";const Sn=Vn,zn=!0,Jn=Object.freeze(Object.defineProperty({__proto__:null,csr:Sn,prerender:zn},Symbol.toStringTag,{value:"Module"}));function Yn(Fn){let l,kn='<ol class="toc-level toc-level-1"><li class="toc-item toc-item-h1"><a class="toc-link toc-link-h1" href="#vault">Vault</a></li><li class="toc-item toc-item-h1"><a class="toc-link toc-link-h1" href="#coupon">Coupon</a></li><li class="toc-item toc-item-h1"><a class="toc-link toc-link-h1" href="#gantry">Gantry</a></li><li class="toc-item toc-item-h1"><a class="toc-link toc-link-h1" href="#battery">Battery</a></li></ol>',U,F,i,rn="Vault",A,y,mn="The vault allows swapping coins for fungible tokens on a 1:1 basis until a certain block height is reached. When the <code>locktime</code> has been met, the vault allows bi-directional swapping.",L,h,dn="Although the vault may lock coins against any fungible token, only contractually issued tokens with the full auditable supply sent to the vault should be treated as locked futures on the open market.",H,b,R,An=`<code class="language-solidity"><span class="token keyword">pragma</span> cashscript <span class="token operator">^</span><span class="token version number">0.10.0</span><span class="token punctuation">;</span>
...
<span class="token comment">// is the first input and output. If the locks isn't spendable, or not the first</span>
<span class="token comment">// input, coupons will no be redeemable.</span>
<span class="token comment">//</span>
...
<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">function</span> <span class="token function">execute</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
        ...
        <span class="token punctuation">&#125;</span>
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`;return{c(){l=p("nav"),l.innerHTML=kn,U=e(),F=e(),i=p("h1"),i.textContent=rn,A=e(),y=p("p"),y.innerHTML=mn,L=e(),h=p("p"),h.textContent=dn,H=e(),b=p("pre"),R=new on(!1),V=e(),r=p("h1"),r.textContent=yn,M=e(),x=p("p"),x.textContent=hn,G=e(),f=p("p"),f.textContent=bn,D=e(),g=p("p"),g.innerHTML=xn,X=e(),w=p("p"),w.innerHTML=fn,S=e(),v=p("pre"),z=new on(!1),Y=e(),m=p("h1"),m.textContent=gn,K=e(),T=p("p"),T.textContent=wn,j=e(),_=p("p"),_.textContent=vn,Q=e(),C=p("p"),C.textContent=Tn,J=e(),P=p("table"),P.innerHTML=_n,W=e(),O=p("p"),O.textContent=Cn,Z=e(),I=p("p"),I.innerHTML=Pn,$=e(),q=p("p"),q.textContent=On,nn=e(),N=p("pre"),sn=new on(!1),an=e(),d=p("h1"),d.textContent=In,tn=e(),E=p("p"),E.textContent=qn,pn=e(),B=p("pre"),en=new on(!1),this.h()},l(n){l=o(n,"NAV",{class:!0,"data-svelte-h":!0}),u(l)!=="svelte-9f2uen"&&(l.innerHTML=kn),U=c(n),Xn("svelte-zpelw2",document.head).forEach(s),F=c(n),i=o(n,"H1",{id:!0,"data-svelte-h":!0}),u(i)!=="svelte-1ndpua0"&&(i.textContent=rn),A=c(n),y=o(n,"P",{"data-svelte-h":!0}),u(y)!=="svelte-3k23hk"&&(y.innerHTML=mn),L=c(n),h=o(n,"P",{"data-svelte-h":!0}),u(h)!=="svelte-1q9znac"&&(h.textContent=dn),H=c(n),b=o(n,"PRE",{class:!0});var Nn=cn(b);R=un(Nn,!1),Nn.forEach(s),V=c(n),r=o(n,"H1",{id:!0,"data-svelte-h":!0}),u(r)!=="svelte-1grnp6w"&&(r.textContent=yn),M=c(n),x=o(n,"P",{"data-svelte-h":!0}),u(x)!=="svelte-y3xa8e"&&(x.textContent=hn),G=c(n),f=o(n,"P",{"data-svelte-h":!0}),u(f)!=="svelte-1xzb9ty"&&(f.textContent=bn),D=c(n),g=o(n,"P",{"data-svelte-h":!0}),u(g)!=="svelte-g6us73"&&(g.innerHTML=xn),X=c(n),w=o(n,"P",{"data-svelte-h":!0}),u(w)!=="svelte-1ozf3od"&&(w.innerHTML=fn),S=c(n),v=o(n,"PRE",{class:!0});var En=cn(v);z=un(En,!1),En.forEach(s),Y=c(n),m=o(n,"H1",{id:!0,"data-svelte-h":!0}),u(m)!=="svelte-1px4dhc"&&(m.textContent=gn),K=c(n),T=o(n,"P",{"data-svelte-h":!0}),u(T)!=="svelte-1oz9at7"&&(T.textContent=wn),j=c(n),_=o(n,"P",{"data-svelte-h":!0}),u(_)!=="svelte-1v38al8"&&(_.textContent=vn),Q=c(n),C=o(n,"P",{"data-svelte-h":!0}),u(C)!=="svelte-eav5o4"&&(C.textContent=Tn),J=c(n),P=o(n,"TABLE",{"data-svelte-h":!0}),u(P)!=="svelte-wtt2eu"&&(P.innerHTML=_n),W=c(n),O=o(n,"P",{"data-svelte-h":!0}),u(O)!=="svelte-eb4trz"&&(O.textContent=Cn),Z=c(n),I=o(n,"P",{"data-svelte-h":!0}),u(I)!=="svelte-1frtzbk"&&(I.innerHTML=Pn),$=c(n),q=o(n,"P",{"data-svelte-h":!0}),u(q)!=="svelte-17haorz"&&(q.textContent=On),nn=c(n),N=o(n,"PRE",{class:!0});var Bn=cn(N);sn=un(Bn,!1),Bn.forEach(s),an=c(n),d=o(n,"H1",{id:!0,"data-svelte-h":!0}),u(d)!=="svelte-10kj1o6"&&(d.textContent=In),tn=c(n),E=o(n,"P",{"data-svelte-h":!0}),u(E)!=="svelte-11g838d"&&(E.textContent=qn),pn=c(n),B=o(n,"PRE",{class:!0});var Un=cn(B);en=un(Un,!1),Un.forEach(s),this.h()},h(){k(l,"class","toc"),document.title="Contracts",k(i,"id","vault"),R.a=null,k(b,"class","language-solidity"),k(r,"id","coupon"),z.a=null,k(v,"class","language-solidity"),k(m,"id","gantry"),sn.a=null,k(N,"class","language-solidity"),k(d,"id","battery"),en.a=null,k(B,"class","language-solidity")},m(n,a){t(n,l,a),t(n,U,a),t(n,F,a),t(n,i,a),t(n,A,a),t(n,y,a),t(n,L,a),t(n,h,a),t(n,H,a),t(n,b,a),R.m(An,b),t(n,V,a),t(n,r,a),t(n,M,a),t(n,x,a),t(n,G,a),t(n,f,a),t(n,D,a),t(n,g,a),t(n,X,a),t(n,w,a),t(n,S,a),t(n,v,a),z.m(Ln,v),t(n,Y,a),t(n,m,a),t(n,K,a),t(n,T,a),t(n,j,a),t(n,_,a),t(n,Q,a),t(n,C,a),t(n,J,a),t(n,P,a),t(n,W,a),t(n,O,a),t(n,Z,a),t(n,I,a),t(n,$,a),t(n,q,a),t(n,nn,a),t(n,N,a),sn.m(Hn,N),t(n,an,a),t(n,d,a),t(n,tn,a),t(n,E,a),t(n,pn,a),t(n,B,a),en.m(Rn,B)},p:ln,i:ln,o:ln,d(n){n&&(s(l),s(U),s(F),s(i),s(A),s(y),s(L),s(h),s(H),s(b),s(V),s(r),s(M),s(x),s(G),s(f),s(D),s(g),s(X),s(w),s(S),s(v),s(Y),s(m),s(K),s(T),s(j),s(_),s(Q),s(C),s(J),s(P),s(W),s(O),s(Z),s(I),s($),s(q),s(nn),s(N),s(an),s(d),s(tn),s(E),s(pn),s(B))}}}class Wn extends Gn{constructor(l){super(),Dn(this,l,null,Yn,Mn,{})}}export{Wn as component,Jn as universal};
//# sourceMappingURL=4.DfS_fDgH.js.map
